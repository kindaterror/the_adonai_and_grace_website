...
export async function GET(req: Request, res: Response) {
  console.log("=== TEACHER API BOOKS GET ===");
  ...
  try {
    ...
    // list (auth optional, same as books route)
    let user: any = null;
    try {
...
export async function PUT(req: Request, res: Response) {
  console.log("=== TEACHER API BOOKS PUT ===");
  ...
  quizMode: safeQuizMode,
    ...
    console.error("=== TEACHER API: Error updating book ===", error);
